...
// LOWER COMBOS
const uint16_t PROGMEM combo_caps[] = {KC_1, KC_GRV};
const uint16_t PROGMEM combo_ent1[] = {KC_BSPC, KC_BSLS};
const uint16_t PROGMEM combo_left1[] = {KC_6, KC_PSCR};
const uint16_t PROGMEM combo_down1[] = {KC_7, KC_MINS};
const uint16_t PROGMEM combo_up1[] = {KC_8, KC_EQL};
const uint16_t PROGMEM combo_right1[] = {KC_9, KC_LBRC};
// RAISE COMBOS
const uint16_t PROGMEM combo_ent2[] = {KC_F11, KC_F12};
const uint16_t PROGMEM combo_left2[] = {KC_F6, KC_MPRV};
const uint16_t PROGMEM combo_down2[] = {KC_F7, KC_VOLD};
const uint16_t PROGMEM combo_up2[] = {KC_F8, KC_VOLU};
const uint16_t PROGMEM combo_right2[] = {KC_F9, KC_MNXT};
...
combo_t key_combos[] = {
    ...
    COMBO(combo_ent1, KC_ENT),
    COMBO(combo_left1, KC_LEFT),
    COMBO(combo_down1, KC_DOWN),
    COMBO(combo_up1, KC_UP),
    COMBO(combo_right1, KC_RIGHT),

    // RAISE COMBOS
    COMBO(combo_ent2, KC_ENT),
    COMBO(combo_left2, KC_LEFT),
    COMBO(combo_down2, KC_DOWN),
    COMBO(combo_up2, KC_UP),
    COMBO(combo_right2, KC_RIGHT)
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
            ...
            KC_GRV , XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,  KC_PSCR,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS,
                              KC_LCTL,  KC_LGUI, KC_LALT,  KC_SPC,   _______, _______),

    [_RAISE] = LAYOUT(
            KC_F1,   KC_F2,   KC_F3,    KC_F4,   KC_F5,    KC_F6,    KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
            XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,  KC_MPRV,  KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY, KC_F12,
                              KC_LCTL,  KC_LGUI, KC_LALT,  KC_SPC,   _______, _______),
