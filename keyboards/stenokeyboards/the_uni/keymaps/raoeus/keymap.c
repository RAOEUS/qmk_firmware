...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_DEL,
                          KC_LCTL, KC_LGUI, KC_LALT, MT(MOD_LSFT, KC_SPC),  LOWER,   RAISE),

    [_UTILITY] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPRV,               KC_VOLD, KC_VOLU, KC_MNXT,  XXXXXXX, XXXXXXX,
        KC_LSFT, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_LEFT,               KC_DOWN, KC_UP,   KC_RIGHT, XXXXXXX, XXXXXXX,
                          _______, STN_N1,  XXXXXXX, MT(MOD_LSFT, KC_SPC),  XXXXXXX, XXXXXXX),
    ...
    [_LOWER] = LAYOUT(
        ...
        KC_GRV,  XXXXXXX, XXXXXXX, KC_TAB,  KC_ESC,  KC_PSCR,               KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC,  KC_BSLS,
                          KC_LCTL, KC_LGUI, KC_LALT, MT(MOD_LSFT, KC_SPC),  _______, _______),
