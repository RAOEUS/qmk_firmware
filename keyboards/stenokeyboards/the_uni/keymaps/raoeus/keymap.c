...
combo_t key_combos[] = {
    // QWERTY COMBOS
    COMBO(combo_a, KC_A), COMBO(combo_s, KC_S), COMBO(combo_d, KC_D), COMBO(combo_f, KC_F), COMBO(combo_g, KC_G), COMBO(combo_h, KC_H), COMBO(combo_j, KC_J), COMBO(combo_k, KC_K), COMBO(combo_l, KC_L), COMBO(combo_scln, KC_SCLN), COMBO(combo_quote, KC_QUOT),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_BSPC, KC_GRV, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, _______, _______),

    [_RAISE] = LAYOUT(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY, KC_F12, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, _______, _______),
